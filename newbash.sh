...
curl --request GET \
  ...
  --user 'rajashekarkoppula5@gmail.com:4niGWaCCtt13mWYyt4iJC57D' \
...
curl -X POST -H "Content-Type: application/json" -H "Authorization: Basic $(echo -n rajashekarkoppula5@gmail.com:4niGWaCCtt13mWYyt4iJC57D | base64)" -d "$DATA" "$URL"
